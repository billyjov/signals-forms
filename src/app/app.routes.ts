...
export const routes: Routes = [
  ...
  },
  {
    path: 'async/signals',
    loadComponent: () =>
      import('./forms/async/signals/async-signals.component').then(
        (m) => m.AsyncSignalsComponent
      )
  },
  {
    path: 'array/reactive',
  ...
  },
  {
    path: 'array/signals',
    loadComponent: () =>
      import('./forms/array/signals/array-signals.component').then(
        (m) => m.ArraySignalsComponent
      )
  }
];
